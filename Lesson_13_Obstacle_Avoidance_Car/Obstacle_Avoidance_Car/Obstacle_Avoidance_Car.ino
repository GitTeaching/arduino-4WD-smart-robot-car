...
#define Lpwm_pin  9     //pin of controlling speed---- ENA of motor driver board 5
#define Rpwm_pin  10    //pin of controlling speed---- ENB of motor driver board
int pinLB=5;             //pin of controlling turning---- IN1 of motor driver board 2
int pinLF=6;             //pin of controlling turning---- IN2 of motor driver board 4
int pinRB=7;            //pin of controlling turning---- IN3 of motor driver board 7
int pinRF=8;            //pin of controlling turning---- IN4 of motor driver board 8
...
unsigned char DuoJiao=0;    //initialized angle of motor at 60°
